...
function Hero() {
  ...
  return (
    // Changed to w-full so the background image stretches across the entire screen
    <section id="hero" ref={ref} className="min-h-screen w-full flex items-center relative overflow-hidden">
      ...
      {/* Structural grid background lines (Constrained to max-w-7xl to match page) */}
      ...
      {/* Inner wrapper to keep text aligned with the rest of the portfolio sections */}
      <div className="max-w-7xl mx-auto w-full px-6 pt-20 relative z-10">
        ...
        >
          ...
          <motion.div variants={item} className="flex gap-4 flex-wrap">
            <a href="#projects" className="bg-textMain text-base font-bold px-8 py-4 hover:bg-accent hover:text-white transition-colors uppercase tracking-widest text-sm flex items-center gap-2 group shadow-lg shadow-accent/20">
              View Projects
