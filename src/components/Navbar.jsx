  ...
  return (
    <>
      <motion.nav
        ...
        style={scrolled ? { background: 'rgba(28, 28, 30, 0.75)' } : {}}
      >
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <kbd className="hidden sm:inline px-1 py-0.2 rounded bg-zinc-800 text-[10px] text-zinc-400 border border-zinc-700">⌘K</kbd>
            </button>
            ...
            <div className="flex flex-col gap-3">
              {navItems.map((item) => (
                <Link
                  ...
                  className="text-sm text-zinc-400 hover:text-white transition-colors py-2 border-b border-zinc-800/50 flex items-center justify-between"
                >
