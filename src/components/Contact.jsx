...
import { 
  FaGithub, FaLinkedin, FaInstagram, FaXTwitter, FaPaperPlane, 
  FaCopy, FaCheck, FaEnvelope
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('Something went wrong. Please email me directly at anmolsriv073@gmail.com')
      }
    } catch (error) {
      alert('Unable to send message. Please email me directly at anmolsriv073@gmail.com')
    }
    setLoading(false)
  }

  const socialLinks = [
    { icon: FaGithub, link: 'https://github.com/Anmol-Srivastava-073', name: 'GitHub' },
    { icon: FaLinkedin, link: 'https://linkedin.com/in/anmol-srivastava-46430727a', name: 'LinkedIn' },
    { icon: FaXTwitter, link: 'https://x.com/anmol_sriv073', name: 'Twitter' },
    { icon: FaInstagram, link: 'https://instagram.com/anmol_sriv.073', name: 'Instagram' },
    { icon: SiSubstack, link: 'https://substack.com/@anmolsriv073', name: 'Substack' },
  ]

  return (
    <section id="contact" className="py-28 px-6 border-t border-zinc-800 bg-[#050507]">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-3">
                <div className="text-xs text-zinc-500 mb-3">Find me online</div>
